				...
				tasks: [
					{
						...
						question:
							"Отметь натуральные числа: \\(-7\\), \\(93\\), \\(2415\\), \\(4\\), \\(\\sqrt{11}\\), \\(-7,3\\)",
						images: [],
						parts: [
							{
								type: "checkbox",
					...
					},
					{
						...
						question:
							"Отметь иррациональные числа: \\(-290,91\\), \\(9,(747)\\), \\(\\sqrt{13}\\), \\(π\\), \\(\\sqrt{0,16}\\), \\(0\\)",
						images: [],
						parts: [
							{
								type: "checkbox",
					...
					},
					{
						...
						question:
							"Вычислить: \\(\\sqrt{96} \\cdot \\sqrt{24}\\)",
						images: [],
						parts: [
							{
								type: "radio",
					...
					},
					{
						...
						question:
							"Ответом выражения \\(\\sqrt{5} \\cdot \\sqrt{5}\\) будет: рациональное число, иррациональное число",
						images: [],
						parts: [
							{
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди все значения \\(a\\) (натуральное число), при которых \\(x\\) и \\(y\\) являются натуральными числами: \\(x = 6/a+14\\); \\(х = 7 \\cdot a + 12/a\\).",
						images: [],
						parts: [
							{
								type: "checkbox",
					...
					},
					{
						...
						question:
							"Вычисли: \\((\\sqrt{256} - 7)(7 + 8\\sqrt{4}) =\\) и отметь, каким числом является числовое значение выражения",
						images: [],
						parts: [
							{
								type: "input",
					...
					},
					{
						...
						title: "Интервал",
						question:
							"Отметь рациональные числа, расположенные на интервале \\((2,8; \\sqrt{8})\\): \\(\\sqrt{9}\\), \\(2,802\\), \\(2,8\\), \\(2,81\\), \\(\\sqrt{7}\\)",
						images: [],
						parts: [
							{
								type: "checkbox",
					...
					},
					{
						...
						question:
							"Реши: \\(\\sqrt{53,(7)}\\). Ответ запиши в виде обыкновенной дроби",
						images: [],
						parts: [
							{
								type: "input",
					...
					},
					{
						...
						title: "Уравнение",
						question:
							"Найди \\(x: 13,(4) \\cdot x - 1 = 0\\). Запиши ответ в виде обыкновенной дроби",
						images: [],
						parts: [
							{
								type: "input",
				...
				tasks: [
					{
						...
						question:
							"Реши неравенство \\(x + \\frac{8}{5} > 6 - \\frac{x}{3}\\). Выбери правильный вариант ответа:<br/>• \\(x > 15\\)<br/>• \\(x > 6\\)<br/>• \\(x < 0,75\\)<br/>• \\(x < 8\\)<br/>• \\(x > 0,75\\)<br/>• \\(x > -0,75\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди дискриминант квадратного уравнения \\(10x^2 + 15x + 20 = 0\\). Ответ: \\(D =\\)",
						parts: [
							{
								partId: "1",
								type: "input",
					...
					},
					{
						...
						question:
							"Определи число корней квадратного уравнения \\(2x^2 + 19x + 1 = 0\\). Выбери правильный вариант ответа:<br/>• Бесконечно много корней<br/>• Нет верного ответа<br/>• Нет корней<br/>• \\(Два\\) корня",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди корни квадратного уравнения \\(x^2 + 3x + 2 = 0\\). (Первым вводи больший корень; если корни одинаковые, впиши одинаковые числа в оба поля.)<br/>Заполни: \\(x_1 = ( )\\), \\(x_2 = ( )\\).",
						parts: [
							{
								partId: "1",
								question: "\\(x_1 = ( )\\)",
					...
					},
					{
						...
						question:
							"Расставь порядок действий в выражении: \\(xv - \\frac{v^2}{x^2 - v^2} : x + v^2(x - v) + \\left(x - \\frac{v}{x} + v \\cdot x - \\frac{v}{2(x + v)} - \\frac{v}{x} - v\\right)\\). Введи нужные числа в поля.",
						parts: [
							{
								partId: "1",
								question: "Часть 1",
					...
					},
					{
						...
						question:
							"Представь в виде дроби \\((10 + tu):(10 - tu)\\). Выбери правильный вариант ответа:<br/>• \\(\\frac{10u+t}{10u-t}\\)<br/>• другой ответ<br/>• \\((10+t/u)^2\\)<br/>• \\(\\frac{10u-t}{10u+t}\\)<br/>• \\(\\frac{100-t^2}{u^2}\\)<br/>• \\(\\frac{u+t}{u-t}\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Представь в виде дроби \\((z + \\frac{z}{d}) \\cdot (z - \\frac{z}{d})\\). Выбери правильный вариант ответа:<br/>• \\(\\frac{z^2(d^2-2d+1)}{d^2}\\)<br/>• \\(\\frac{z+\\frac{z}{d}}{z-\\frac{z}{d}}\\)<br/>• другой ответ<br/>• \\(\\frac{(zd-z)^2}{d}\\)<br/>• \\(\\frac{z^2(d^2-1)}{d^2}\\)<br/>• \\(\\frac{z^2(d^2+2d+1)}{d^2}\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Запиши проценты в виде несократимой дроби: \\(95\\% = \\frac{( x )}{( y )}\\).",
						parts: [
							{
								partId: "1",
								question: "x",
					...
					},
					{
						...
						question:
							"Реши неравенство \\(4y^2 - 4y(y + 5) \\le 100\\). Выбери правильный вариант ответа:<br/>• \\(y \\ge -5\\)<br/>• \\(y \\le -6\\)<br/>• \\(y \\le -5\\)<br/>• \\(y \\ge 6\\)<br/>• \\(y \\ge -6\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"При каких значениях \\(x\\) имеет смысл выражение \\(\\sqrt{(x - 6)(x + 5)}\\)? Выбери правильный вариант ответа:<br/>• \\(-5 < x < 6\\)<br/>• \\(x \\le -5, x \\ge 6\\)<br/>• \\(x < -5, x > 6\\)<br/>• \\(-5 \\le x \\le 6\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди область определения выражения \\(f(x) = \\sqrt{x^2 - 5x + 6}\\). Выбери верный вариант ответа:<br/>• \\(2 \\le x \\le 3\\)<br/>• \\(2 < x < 3\\)<br/>• \\(x \\le 2, x \\ge 3\\)<br/>• другой ответ<br/>• \\(x < 2, x > 3\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди область определения выражения \\(f(x) = \\frac{\\sqrt{3}}{5x - x^2 - 6}\\). Выбери правильный вариант ответа:<br/>• \\(2 < x < 3\\)<br/>• \\(2 \\le x \\le 3\\)<br/>• \\(x < 2, x > 3\\)<br/>• \\(x \\le 2, x \\ge 3\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Определи, при каких значениях \\(x\\) имеет смысл выражение \\(\\frac{\\sqrt{1}}{2x^2 - 7x + 6}\\). Выбери правильный вариант ответа:<br/>• другой ответ<br/>• \\(x \\le 1,5, x \\ge 2\\)<br/>• \\(1,5 < x < 2\\)<br/>• \\(x \\ge 2\\)<br/>• \\(x > 2\\)<br/>• \\(x < 1,5, x > 2\\)<br/>• \\(x < 1,5\\)<br/>• \\(1,5 \\le x \\le 2\\)<br/>• \\(\\varnothing\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Реши квадратное уравнение \\(2x^2 - 5x + 3 = 0\\). Корни: \\(x_1 = ( )\\), \\(x_2 = ( )\\) (первым пиши больший корень).",
						parts: [
							{
								partId: "1",
								question: "\\(x_1 = ( )\\)",
					...
					},
					{
						...
						question:
							"Реши квадратное уравнение \\(2(4x - 18)^2 - 4(4x - 18) + 2 = 0\\) (первым вводи больший корень): \\(x_1 =\\); \\(x_2 =\\).<br/>Дополнительный вопрос: какой способ решения рациональнее использовать?",
						parts: [
							{
								partId: "1",
								type: "input",
					...
					},
					{
						...
						question:
							"Найди корни уравнения \\(-11,7(x - 16)(x + 28) = 0\\). (Первым пиши меньший корень.)<br/>Заполни: \\(x_1 = ( )\\), \\(x_2 = ( )\\).",
						parts: [
							{
								partId: "1",
								question: "\\(x_1\\)",
					...
					},
					{
						...
						question:
							"Выясни, является ли тождеством равенство \\(\\frac{4p - g}{p\\,g} - \\frac{1}{p+g}\\left(\\frac{p}{g} - \\frac{g}{p}\\right) = \\frac{3}{g}\\).<br/>После преобразования левой части получим выражение (выбери правильный ответ):<br/>• \\(\\frac{v}{u} - v\\)<br/>• \\(\\frac{v(u-v)}{u^2 - 2uv + v^2}\\)<br/>• \\(\\frac{uv}{u^2}\\)<br/>• \\(\\frac{v}{u} + v\\)<br/>После преобразования правой части получим выражение (выбери правильный ответ):<br/>• v1<br/>• v2<br/>• − (не используется)<br/>• v3<br/>Данное равенство ( ) тождеством.",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди такое целочисленное значение параметра \\(m\\), при котором множество решений неравенства \\((m - x)(x + 3) \\ge 0\\) содержит четыре целых числа. Выбери верный вариант ответа:<br/>• другой ответ<br/>• \\(m_1 = 1, m_2 = 3\\)<br/>• \\(m = 0\\)<br/>• \\(m_1 = -1, m_2 = -5\\)<br/>• \\(m_1 = 0, m_2 = -6\\)<br/>• \\(m_1 = 1, m_2 = -7\\)<br/>• \\(m_1 = -2, m_2 = -4\\)",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Найди такое натуральное значение параметра \\(m\\), при котором множество решений неравенства \\((x + m)(x - 5) \\le 0\\) содержит девять целых чисел. Выбери верный вариант ответа:<br/>• \\(m = 0\\)<br/>• \\(m_1 = 2, m_2 = 3\\)<br/>• \\(m = 5\\)<br/>• \\(m = 6\\)<br/>• \\(m = 10\\)<br/>• \\(m_1 = 1, m_2 = -7\\)<br/>• \\(m_1 = 3, m_2 = 12\\)<br/>• \\(m_1 = -2, m_2 = -4\\)<br/>• \\(m = 3\\)<br/>• другой ответ",
						parts: [
							{
								partId: "1",
								type: "radio",
					...
					},
					{
						...
						question:
							"Разложи на множители квадратный трёхчлен \\(x^2 + 4x + 3\\). (Запиши: \\(x^2+4x+3 = (x + ( ))(x + ( ))\\).)",
						parts: [
							{
								partId: "1",
								type: "radio",
